...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.createModal = function ({
  ...
  for (let i = 0; i < this.length; i++) {
    ...
    (0,_core__WEBPACK_IMPORTED_MODULE_0__["default"])(this[i].getAttribute('data-taeget')).fadeIn(500);
  }
};
...
(0,_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('#trigger').click(() => (0,_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('#trigger').createModal({
  text: {
    title: 'Modal title',
    body: 'Lorem ipsum, dolor sit amet consectetur adipisicing elit. Expedita ea quia quas quis dolor aliquam eveniet repellat neque possimus in, nihil laboriosam cum accusantium deserunt hic odit sint nobis similique!'
  },
  btns: {
    count: 3,
